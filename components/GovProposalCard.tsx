...
import defaultpfp from "../assets/images/admin/government.png";
    ...
    <Animatable.View
      ...
      <View
        ...
        <TouchableOpacity
          onPress={() =>
            router.push({
              pathname: "/screens/DetailedGovProposal",
              params: { govProposalId: govProposalId },
            })
          }>
          <ImageBackground
            source={{
              uri: `http://${API_IP_ADDRESS}:8000/uploads/govProposalMedia/${proposalMedia[0]}`,
            }}
        ...
        <View
          ...
          <Ionicons
            ...
            style={{ width: "8%" }}
            onPress={() => 
              router.push(`/screens/DetailedGovProposal?govProposalId=${govProposalId}&suggestions=true`)
            }
          />
